...
template<serializable tkey, serializable tvalue, compator<tkey> compare, std::size_t t>
size_t B_tree_disk<tkey, tvalue, compare, t>::btree_disk_const_iterator::depth() const {
	return _path.size() - 1;
}

template<serializable tkey, serializable tvalue, compator<tkey> compare, std::size_t t>
size_t B_tree_disk<tkey, tvalue, compare, t>::btree_disk_const_iterator::index() {
	return _index;
}
